                            ...
                            <div class="row">
                                <div class="p-6 col-12 text-gray-900 dark:text-gray-100">
                                    ...
                                    <label class="block">
                                        ...
                                        <input required placeholder="Titre de la catégorie" name="title" type="text" class="mt-1 transition-all block w-full px-3 py-2 gb-white border border-slate-300 rounded-md text-sm shadow-sm placeholder-slate-400 focus:outline-none focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500">
                                        @error('title')
                                    ...
                                    <label class="block mt-3">
                                        ...
                                        <input required placeholder="Slug de la categorie" name="slug" type="text" class="mt-1 transition-all block w-full px-3 py-2 gb-white border border-slate-300 rounded-md text-sm shadow-sm placeholder-slate-400 focus:outline-none focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500" pattern="[a-z0-9-]+">
                                        @error('slug')
                                        <div class="flex bg-yellow-100 dark:bg-yellow-300 text-slate-600 items-start gap-4 rounded-sm shadow-sm mt-2 p-4">
                                            {{ $message }}
                                        </div>
