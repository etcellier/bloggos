                        ...
                        <div class="p-6 col-4 text-gray-900 dark:text-gray-100 bg-white rounded hover:shadow transition-all flex flex-col h-full gap-2">
                            <div class="flex justify-between">
                                <div class="flex gap-2">
                                    ...
                                    @else
                                        <span class="inline-flex items-center rounded-md bg-red-50 px-2 py-1 text-xs font-medium text-red-700 ring-1 ring-inset ring-red-600/10">Non publié</span>
                                    @endif
                            ...
                            <div class="flex gap-2">
                                ...
                                @if ($post->allow_comments)
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 stroke-1 stroke-slate-400">
