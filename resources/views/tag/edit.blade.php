                            ...
                            <div class="row">
                                <div class="p-6 col-12 text-gray-900 dark:text-gray-100">
                                    ...
                                    <label class="block">
                                        ...
                                        <input value="{{ $tag->name }}" required placeholder="Titre du tag" name="name"
                                               type="text"
                                    ...
                                    <label class="block mt-3">
                                        ...
                                        <input value="{{ $tag->slug }}" required placeholder="Slug du tag" name="slug"
                                               type="text"
                                               class="mt-1 transition-all block w-full px-3 py-2 gb-white border border-slate-300 rounded-md text-sm shadow-sm placeholder-slate-400 focus:outline-none focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500"
                                               pattern="[a-z0-9-]+">
                                        @error('slug')
                                    ...
                                    <label class="block mt-3">
                                        ...
                                        <input value="{{ $tag->color }}" type="text" name="color"
                                               class="mt-1 transition-all block w-full px-3 py-2 gb-white border border-slate-300 rounded-md text-sm shadow-sm placeholder-slate-400 focus:outline-none focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500"
                                               data-coloris>
                                        @error('color')
                                        <div
                                    ...
                                    <div class="mt-6 flex items-center justify-end gap-x-6">
                                        <a href="{{ route("tag.list") }}" type="button"
